 ...
 if (level[l] == "division") {
    ...
    if (level[l] == "puma") {
      ...
      if (level[l] == "state.legislative.district.upper") {
        output <- data.table::data.table(
          geoid = paste0(sprintf("%02d", as.numeric(geo$state)), sprintf("%02d", as.numeric(geo$statelegislativedistrictupper))),
          sumlevel = "610",
          region = NA,
          division = NA,
          st_fips = geo$state,
    ...
    if (level[l] == "state.legislative.district.lower") {
        output <- data.table::data.table(
          geoid = paste0(sprintf("%02d", as.numeric(geo$state)), sprintf("%02d", as.numeric(geo$statelegislativedistrictlower))),
          sumlevel = "620",
          region = NA,
          division = NA,
          st_fips = geo$state,
