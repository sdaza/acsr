...
#' @param file The resulting output is written to a csv file rather than to the R prompt. The file name must be specified as a character string. 
...
sumacs  <- function(formula, varname, method, level = "county", endyear = "2013",
                     conf.level=0.90,  one.zero = TRUE, data = NULL, file = NULL,
                     state="WI",
                     county = "*",
                     county_subdivision ="*",
                     tract = "*",
